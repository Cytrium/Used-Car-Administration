...
//sambung relationship table
	...
	$dataC=mysqli_query($samb,"select * from alamat where icpelanggan='$infoB[icpelanggan]'");
...
<table width="700" border="1" align="center">
  ...
  <tr>
	...
	<td width="400"><?php echo $tarikh;?><br></td>
  </tr>  
  
    <tr>
    <td width="300">KAEDAH BAYARAN ( <?php echo $infoA['jenis_bayaran'];?> ):</td>
