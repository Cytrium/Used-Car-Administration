...
<body>
    ...
    <table width="800" border="0">
      <tr>
        ...
        <td width="400" valign="botton"><div align="right">
		<br />
...
<table width="1000" border="1" align="center">
 ...
 <?php	
   ...
   {
	 $data1=mysqli_query($samb,"select * from jualan 
	 where ((MONTH(tarikh)='$bulan' AND YEAR(tarikh)='$tahun') ) order by nomplat,tarikh");   
   }
	elseif ($bulan=="-"&&$tahun!="-")
   {
	 $data1=mysqli_query($samb,"select * from jualan 
	...
	while ($info1=mysqli_fetch_array($data1))
		{
			...
			//susun semula tarikh	
	$tarikh = date("d-m-Y", strtotime($info1['tarikh']));
 ...
 <!–– PAPAR REKOD DALAM JADUAL ––>
  <tr>
    ...
    <td><?php echo "<img src='gambar/".$infokereta['gambar']."' width='200px' height='100px'/>"; ?></td>
