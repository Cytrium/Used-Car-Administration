...
$imageArr = explode('.',$gambar);//tentukan jenis file
...
["tmp_name"],$uploadPath);
    ...
    $result = mysqli_query($samb,"UPDATE kenderaan 
	SET model='$model', tahun_perbuat='$tahun',harga='$harga' ,gambar='$namabarugambar',status='$status'
...
$result = mysqli_query($samb, "SELECT * FROM kenderaan
WHERE nomplat='$nomplat'");
...
<body>
	...
	<tr>
		...
		id="model" value ="<?php echo $model;?>"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td width="400">
		<?php echo "<img src='gambar/".$gambar."' width='200px' height='100px'/>";?>
