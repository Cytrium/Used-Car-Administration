...
{ 
	...
	"INSERT INTO jualan (idjualan,tarikh,jenis_bayaran,nomplat,idpelanggan,idpekerja) 
	...
	//TAMBAH REKOD - TABLE ADDRESS	
	$result3 = mysqli_query($samb, 
	"INSERT INTO alamat (idalamat,alamat1,alamat2,bandar,poskod,negeri,icpelanggan) 
	values (NULL,'$alamat1','$alamat2','$bandar','$poskod','$negeri','$nomic')");	

	//TAMBAH REKOD - KENDERAAN
    $result4 = mysqli_query($samb, 
	"UPDATE kenderaan SET model=model, tahun_perbuat=tahun_perbuat,harga=harga,gambar=gambar,status='SOLD' 
